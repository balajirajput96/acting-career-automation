...
class TestFollowUpTracker(unittest.TestCase):
    ...
    def test_follow_up_needed(self, mock_datetime, mock_get_github_repo):
        ...
        mock_datetime.side_effect = lambda *args, **kw: datetime(*args, **kw) # Make other datetime calls work
        ...
        mock_issue_already_followed.created_at = datetime(2023, 1, 1) # Older than 7 days
        ...
        mock_repo.get_issues.return_value = [mock_issue_old, mock_issue_new, mock_issue_already_followed]
