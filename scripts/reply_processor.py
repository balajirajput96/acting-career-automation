...
def main():
    ...
    def safe_remove_labels(labels_to_remove):
        for label in labels_to_remove:
            if label in current_labels:
                issue.remove_from_labels(label)

    if "/sent" in comment_body:
        safe_remove_labels(["lead-new"])
        ...
        safe_remove_labels(["lead-new", "lead-sent", "follow-up-needed"])
        ...
        safe_remove_labels(["lead-new", "lead-sent"])
        ...
        safe_remove_labels(["follow-up-needed"])
