...
def main():
    ...
    if "/sent" in comment_body:
        ...
        issue.create_comment(
            "Lead marked as sent. Moving to 'Sent' column on Project board (manual action needed for now)."
        )
        ...
        issue.create_comment(
            "Lead marked as rejected. Moving to 'Closed-tracking' column on Project board (manual action needed for now)."
        )
        ...
        issue.create_comment(
            "Lead marked for callback. Moving to 'Follow-up' column on Project board (manual action needed for now)."
        )
